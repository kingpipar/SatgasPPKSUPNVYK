        ...
        <div class="container">
            <div class="footer-grid">
                ...
                <div class="footer-brand">
                    <h4>Satgas PPKS</h4>
                    <p>
                        Satuan Tugas Pencegahan dan Penanganan Kekerasan di lingkungan kampus<br>
                        <strong>UPN "Veteran" Yogyakarta</strong>
                    </p>
                    <p style="font-size: 0.88rem; color: #a3c4b5;">
                        Berkomitmen mewujudkan ruang aman akademik yang inklusif, bermartabat, dan bebas dari segala tindak kekerasan seksual dengan prinsip kerahasiaan penuh bagi korban.
                    </p>
                </div>
                ...
                <div class="footer-column">
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a href="{{ route('profil.satgas') }}">Profil Satgas</a></li>
                        <li><a href="{{ route('profil.logo-filosofi') }}">Logo dan Filosofi</a></li>
                        <li><a href="{{ route('profil.struktur-kepengurusan') }}">Struktur Kepengurusan</a></li>
                        <li><a href="{{ route('pedoman.index') }}">Pedoman & SOP</a></li>
                        <li><a href="{{ route('pelayanan') }}">Alur Pelayanan</a></li>
                        <li><a href="{{ route('galeri.index') }}">Dokumentasi Galeri</a></li>
                    </ul>
                </div>

                <!-- Kolom 3: Layanan & Perlindungan -->
                <div class="footer-column">
                    <h5>Layanan Perlindungan</h5>
                    <ul class="footer-links">
                        <li><a href="{{ route('pelayanan') }}#alur">Alur 5 Langkah Aduan</a></li>
                        <li><a href="{{ route('pelayanan') }}#hak">Hak dan Kerahasiaan Pelapor</a></li>
                        <li><a href="{{ route('pelayanan') }}#faq">Tanya Jawab Seputar PPKS</a></li>
                        <li><a href="{{ config('satgas.google_form_url', env('GOOGLE_FORM_URL', 'https://forms.gle/samplePPKSreportURL')) }}" target="_blank" rel="noopener">Formulir Lapor Online (Google Form)</a></li>
                    </ul>
                </div>
                ...
                <div class="footer-column">
                    ...
                    <div class="footer-contact-item">
                        ...
                        <span>Instagram: <a href="https://instagram.com/satgasppkupnvy" target="_blank" rel="noopener" style="color: #ffd166;">@satgasppkupnvy</a></span>
                    </div>
                    <div class="footer-contact-item">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        ...
                        <span>Email: <a href="mailto:satgas.ppks@upnyk.ac.id" style="color: #ffd166;">satgas.ppks@upnyk.ac.id</a></span>
                    </div>
                </div>
            </div>
